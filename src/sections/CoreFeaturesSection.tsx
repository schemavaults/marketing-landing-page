      ...
      <div className="container px-4 md:px-6">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="mx-auto max-w-[700px] text-muted-foreground text-lg">
            Schema-validated storage, agent-ready APIs, and an AI-first editor —
            everything you need to build type-safe data products without
            writing a line of code (unless you want to).
          </p>
        </div>
