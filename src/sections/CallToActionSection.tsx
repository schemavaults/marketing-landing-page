        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
              {privateBeta
                ? "Be first to build on SchemaVaults."
                : "Ready to simplify how you work with data?"}
            </h2>
            <p className="mx-auto max-w-[600px] text-muted-foreground text-lg">
              {privateBeta ? (
                <>
                  Drop your email to get an invite the moment <Wordmark />{" "}
                  opens to the public. No spam — just one message when early
                  access goes live.
                </>
              ) : (
                <>
                  Subscribe to the <Wordmark /> mailing list for product
                  updates, new schema patterns, and engineering deep dives.
                </>
              )}
            </p>
          </div>
