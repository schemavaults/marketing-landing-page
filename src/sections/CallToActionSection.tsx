        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
              Be first in line when <Wordmark /> opens up.
            </h2>
            <p className="mx-auto max-w-[600px] text-muted-foreground text-lg">
              Drop your email to reserve early access. We'll send you an
              invite the moment your account is ready — no spam, no
              marketing blasts, just a heads-up when it's time to build.
            </p>
          </div>
