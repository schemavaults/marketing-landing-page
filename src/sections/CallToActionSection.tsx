        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-[600px] text-muted-foreground text-lg">
              {privateBeta ? (
                <>
                  <Wordmark /> is currently in private beta. Drop your email
                  below and we&apos;ll let you know the moment public access
                  opens — plus send you an early-access invite when one
                  becomes available.
                </>
              ) : (
                <>
                  Join the <Wordmark /> mailing list for product updates, new
                  schema patterns, and the occasional deep-dive on building
                  type-safe AI workflows. No spam — unsubscribe anytime.
                </>
              )}
            </p>
          </div>
