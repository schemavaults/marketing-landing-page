        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
              Stop wrangling untyped data. Start shipping.
            </h2>
            <p className="mx-auto max-w-[600px] text-muted-foreground text-lg">
              Join the launch waitlist to be among the first to build with{" "}
              <Wordmark />. We&apos;ll email you the moment early access opens —
              no spam, ever.
            </p>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            Free forever plan • No credit card required • Self-host or use our
            cloud
          </p>
        </div>
      </div>
