...
const description: string =
  "Define your data shape once. Validate, store, and re-use the same schemas across your AI agents, workflows, frontends, backends, and content pipelines — without writing the same types over and over.";
...
function HeroSectionContent(): ReactElement {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg md:text-xl lg:text-2xl font-medium text-center tracking-tight text-muted-foreground">
        Stop wiring up brittle data flows. Ship type-safe data to your AI
      ...
      {!privateBeta && (
        <p className="text-xs md:text-sm text-muted-foreground mt-3 text-center">
          Free forever plan • No credit card required • Cloud or self-host
        </p>
      )}
    </div>
  );
