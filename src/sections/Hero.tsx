...
const description: string =
  "Define your data types once as schemas. Reuse and compose them to validate and store data across your AI agents, workflows, websites, mobile apps, and content management systems.";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <li>End-to-end TypeScript SDK</li>
        <li aria-hidden className="opacity-40">
          •
        </li>
