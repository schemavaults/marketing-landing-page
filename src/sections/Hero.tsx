...
const description: string =
  "Define your data types once. Compose, validate, and store them across every agent, workflow, and app you ship — without writing the same schema twice.";
...
function HeroSectionContent(): ReactElement {
  ...
  return (
    ...
    >
      ...
      >
        One schema. <span className="whitespace-nowrap">Every surface.</span>
      </h1>
      <h2 className="text-lg md:text-xl font-medium text-center tracking-tight text-muted-foreground">
        <Wordmark /> gives your AI agents, workflows, and apps end-to-end
        type-safe data — backed by a graph vault you can query in plain English.
      </h2>
