...
const description: string =
  "Define a schema once. Use it everywhere — to validate, store, and serve type-safe data across your AI agents, workflows, websites, and mobile apps.";
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg md:text-xl font-medium text-center tracking-tight text-muted-foreground">
        Meet <Wordmark /> — the schema-first data platform that keeps your AI
        and your apps speaking the same language.
      </h2>
