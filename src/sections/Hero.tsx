...
const description: string =
  "Define your data shape once. Reuse the same type-safe schemas across your AI agents, workflows, frontends, and backends — and stop writing the same validation, storage, and migration code over and over.";
