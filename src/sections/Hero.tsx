...
const description: string =
  "Stop wrangling untyped JSON. Define your data once, then validate and store it across every agent, workflow, and app you ship — with end-to-end type safety from schema to UI.";
