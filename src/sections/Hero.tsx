...
const description: string =
  "Define your data types once as schemas, then validate, store and reuse them across your AI agents, workflows, apps, and content. Cloud-hosted or self-hosted — same SDK.";
...
function HeroSectionContent(): ReactElement {
  ...
  return (
    ...
    >
      <p className="text-sm md:text-base font-medium uppercase tracking-widest text-primary/80">
        <Wordmark />
      </p>
      <h1
        className={cn(
      ...
      <p className="mt-3 text-xs md:text-sm text-muted-foreground text-center">
        No credit card required · Free forever plan · Self-host or cloud
      </p>
    </div>
  );
}
