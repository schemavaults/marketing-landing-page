...
const description: string =
  "Define your data types once as schemas. Validate, store, and reuse them across your AI agents, workflows, websites, mobile apps, and content management systems — without rewriting types in every codebase.";
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg md:text-xl font-medium text-center tracking-tight text-muted-foreground">
        Welcome to <Wordmark /> — one schema, every codebase.
      </h2>
