...
const description: string =
  "Define your data once as a schema. Reuse it across your AI agents, workflows, apps, and content — fully type-safe, end to end. No more guessing what shape your data is in.";
    ...
    >
      <div
        className={cn(
          ...
          "rounded-full border border-border/60 bg-background/40 backdrop-blur",
      ...
      >
        ...
        <span>
          {privateBeta
            ? "Private beta — invite codes available now"
            : "Now in public release — start free in minutes"}
        </span>
      </div>
      <h1
        className={cn(
      ...
      <h2 className="text-lg md:text-xl font-medium text-center tracking-tight text-muted-foreground">
        Powered by <Wordmark /> — one schema, every layer of your stack.
      </h2>
