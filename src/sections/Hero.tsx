...
const description: string =
  "Define your data types once as schemas, then use, re-use, and compose them across every agent, workflow, app, and content system — without ever guessing what shape your data is in.";
