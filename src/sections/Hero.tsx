...
const description: string =
  "Define your data once. Validate, store, and compose it everywhere — from your AI agents and workflows to your apps and CMS.";
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg md:text-xl font-medium text-center tracking-tight text-muted-foreground">
        Welcome to <Wordmark /> — the graph data platform you can just talk to.
      </h2>
